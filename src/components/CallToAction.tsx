...
const CallToAction = () => (
  <section className="w-full py-14 flex justify-center bg-gradient-to-tr from-gradient2 via-gradient1 to-gradient3 animate-fade-in-up">
    <div className="max-w-2xl bg-white rounded-2xl shadow-card p-10 flex flex-col items-center text-center">
      <h2 className="font-playfair text-2xl md:text-3xl text-primary mb-2">Ready to Start Your Journey?</h2>
